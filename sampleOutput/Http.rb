...
, 		# +byteData+ - CkByteData
, 		# +contentType+ - String
, 		# +md5+ - TrueClass, FalseClass
, 		# +gzip+ - TrueClass, FalseClass
		# returns CkHttpResponse
		#
		# YARD =>
		#
...
, 		# @param  objectName [String]
		# @return  [CkByteData]
		def S3_DownloadBytes(bucketPath, objectName)
			# ...
		end
...
, 		# @param  expire [CkDateTime]
		...
		# ==== Attributes
		#
		# +useHttps+ - TrueClass, FalseClass
, 		# +bucketName+ - String
, 		# +path+ - String
, 		# +numSecondsValid+ - Fixnum
, 		# +awsService+ - String
		# returns String
		#
		# YARD =>
