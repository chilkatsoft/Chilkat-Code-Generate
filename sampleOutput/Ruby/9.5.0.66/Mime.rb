module Chilkat
	class CkMime 
		...
		# @param newval [String]
		# @return [String]
		def get_ContentType(newval) end
		...
		# @param newval [String]
		# @return [String]
		def get_Disposition(newval) end
		...
		# @param newval [TrueClass, FalseClass]
		# @return [Bignum]
		def get_UnwrapExtras(newval) end
		...
		# @param newval [TrueClass, FalseClass]
		# @return [Bignum]
		def get_UseMmDescription(newval) end
