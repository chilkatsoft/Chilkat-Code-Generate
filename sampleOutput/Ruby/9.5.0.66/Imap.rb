module Chilkat
	class CkImap 
		...
		# @param newval [TrueClass, FalseClass]
		# @return [Bignum]
		def get_AutoDownloadAttachments(newval) end
		...
		# @param newval [String]
		# @return [String]
		def get_SearchCharset(newval) end
		...
		# @param newval [String]
		# @return [String]
		def get_SeparatorChar(newval) end
