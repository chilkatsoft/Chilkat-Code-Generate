module Chilkat
	class CkLog 
		...
		# Method: EnterContext
		#
		# Enters a new context labelled with the given tag. Must be paired with a matching call to
		# LeaveContext.
		#
		# @param tag [String]
		#
		...
		# Method: LeaveContext
		#
		# Leaves the current context. A context that is entered and exited without any logging within the
		# context is automatically removed from the log. (To say it another way: Empty contexts are
		...
		# Method: LogDateTime
		#
		# Logs the current date/time in RFC822 format. If ARG2 is _TRUE_, then the GMT/UTC time is logged.
		# Otherwise it is the local time.
		#
		# @param tag [String]
