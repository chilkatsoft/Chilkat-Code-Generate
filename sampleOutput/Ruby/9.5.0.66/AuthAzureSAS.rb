module Chilkat
	class CkAuthAzureSAS 
		# This is the signing key (access key) that must be kept private. It is a base64 string such as
		# "abdTvCZFFoWUyre6erlNN+IOb9qhXgDsyhrxmZvpmxqFDwpl9oD0X9Fy0hIQa6L5UohznRLmkCtUYySO4Y2eaw=="
		#
		...
		#
		# Adds a non-token parameter name/value. This is a value that is included in the string to sign, but
		# is NOT included as a parameter in the Authorization header.
		#
		# @param name [String]
		# @param value [String]
		#
		...
		#
		# Adds a token parameter name/value. This is a value that is included in the string to sign, and is
		# also included as a parameter in the Authorization header.
		#
		# @param name [String]
