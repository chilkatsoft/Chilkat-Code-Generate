module Chilkat
	class CkAuthAzureAD 
		# The access token to be used in Azure AD REST API requests. This property is set on a successful call
		...
		# Specifies the Azure AD client id of the calling web service. To find the calling application's
		# client ID, in the Azure Management Portal, click Active Directory, click the directory, click the
		...
		# A key registered for the calling web service in Azure AD. To create a key, in the Azure Management
		# Portal, click Active Directory, click the directory, click the application, and then click
		# Configure.
		#
		# @param ckStr [CkString]
		#
		...
		# The App ID URI of the receiving web service. To find the App ID URI, in the Azure Management Portal,
		# click Active Directory, click the directory, click the application, and then click Configure.
		#
		# @param ckStr [CkString]
		#
		# @return [String]
