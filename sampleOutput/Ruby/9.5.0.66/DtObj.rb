module Chilkat
	class CkDtObj 
		...
		# @param newval [Fixnum]
		# @return [Bignum]
		def get_StructTmMonth(newval) end
		...
		# @param newval [Fixnum]
		# @return [Bignum]
		def get_StructTmYear(newval) end
