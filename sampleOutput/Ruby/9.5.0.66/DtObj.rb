module Chilkat
	class CkDtObj 
		...
		# _TRUE_ if this is a UTC time, otherwise _FALSE_ if this is a local time.
		#
		# @return [Boolean]
		def get_Utc() end
		...
		# order) year, month, day, hour, minutes, seconds, and a UTC flag having the value of 1/0.
		#
