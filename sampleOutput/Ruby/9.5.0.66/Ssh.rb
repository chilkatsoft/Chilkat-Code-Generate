module Chilkat
	class CkSsh 
		...
		# @param newval [TrueClass, FalseClass]
		# @return [Bignum]
		def get_CaretControl(newval) end
		...
		# @param newval [String]
		# @return [String]
		def get_ReqExecCharset(newval) end
		...
		# @param newval [TrueClass, FalseClass]
		# @return [Bignum]
		def get_StderrToStdout(newval) end
		...
		# @param newval [String]
		# @return [String]
		def get_UserAuthBanner(newval) end
